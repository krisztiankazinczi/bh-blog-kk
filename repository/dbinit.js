...
db.serialize(function () {
    ...
    db.run("CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(100) NOT NULL UNIQUE, username VARCHAR(100) NOT NULL UNIQUE, password VARCHAR(100) NOT NULL UNIQUE, email VARCHAR(100) NOT NULL UNIQUE, isAdmin INTEGER, isSuperAdmin INTEGER)");
    db.run("INSERT INTO users(name, username, password, email, isAdmin, isSuperAdmin) VALUES ('Admin Admin','admin', 'admin', 'lilkrisz17@gmail.com', 1, 0)")
